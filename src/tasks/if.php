 ...
 * Дано число 15.
 * Если оно больше 10,
 * то увеличьте его на 100,
 * иначе уменьшите на 30.
 */
$a = 15;
if ($a > 10) {
    $a += 100;
...
/**
 * Дано число 45. Если оно не меньше 50,
 * то выведите квадрат этого числа,
 * если же это число больше 10 и меньше 30,
 * то выведите ноль,
...
/**
 * Дано два числа a = 19, b = 143.
 * Вывести 'Да', если они отличаются на 100, иначе вывести 'Нет'
 */
$a = 19;
$b = 143;
if (abs($a - $b) >= 100) {
...
/**
 * Дано два натуральных числа 15, 30.
 * Вывести 'Да', если они отличаются не более чем на 20,
 * иначе вывести 'Нет'.
 */
$a = 11;
$b = 30;
...
$n = mt_rand(1, 200);
if ($n > 25 && $n < 100) {
    echo "Число {$n} содержится в интервале (25,100)";
} else {
    echo "Число {$n} не содержится в интервале (25,100)";
}
