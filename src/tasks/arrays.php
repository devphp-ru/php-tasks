...
/**
 * Дан массив с элементами c неупорядоченными элементами. Используте функцию array_map для преобразования элементов массива в верхний регистр.
 * Sample Input: ['a', 'b', 'c', 'd', 'e']
 * Sample Output: ['A', 'B', 'C', 'D', 'E']
 */
$a = ['a', 'b', 'c', 'd', 'e'];
$result = array_map('mb_strtoupper', $a);
print_r($result);
...
$a = range('a', 'z');
shuffle($a);
$result = implode('', array_slice($a, 0, 6));
echo $result;

/**
 * Дан массив с помощью функции array_splice преобразуйте данные массив.
...
/**
 * Дан массив с помощью функции array_splice добавьте в него новые элементы.
 * Sample Input: [1, 2, 3, 4, 5]
 * Sample Output: [1, 2, 3, 'a', 'b', 'c', 4, 5]
 */
$a = [1, 2, 3, 4, 5];
...
/**
 * Дан массив с элементами. Добавьте ему в начало элемент 0, а в конец - элемент 6.
 * Sample Input: [1, 2, 3, 4, 5]
 * Sample Output: [0, 1, 2, 3, 4, 5, 6]
 */
$a = [1, 2, 3, 4, 5];
array_unshift($a, 0);
array_push($a, 6);
